...
User.create! name: "Admin", email: "admin@edu.com", password: "123123",
...
bkm1.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm2.targets.create! amount: 85, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm3.targets.create! amount: 65, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm4.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm5.targets.create! amount: 35, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm6.targets.create! amount: 67, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm7.targets.create! amount: 47, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm8.targets.create! amount: 23, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm9.targets.create! amount: 25, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm10.targets.create! amount: 100, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm11.targets.create! amount: 90, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm22.targets.create! amount: 22, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm12.targets.create! amount: 50, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm13.targets.create! amount: 90, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm14.targets.create! amount: 33, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm15.targets.create! amount: 22, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm16.targets.create! amount: 43, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm17.targets.create! amount: 40, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm18.targets.create! amount: 35, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm19.targets.create! amount: 45, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm20.targets.create! amount: 25, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm21.targets.create! amount: 20, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
bkm23.targets.create! amount: 50, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
...
ktm1.targets.create! amount: 100, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm2.targets.create! amount: 175, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm3.targets.create! amount: 130, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm4.targets.create! amount: 75, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm5.targets.create! amount: 75, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm6.targets.create! amount: 100, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm7.targets.create! amount: 55, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm8.targets.create! amount: 185, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm9.targets.create! amount: 135, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm10.targets.create! amount: 72, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm11.targets.create! amount: 40, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm12.targets.create! amount: 130, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm13.targets.create! amount: 25, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
ktm14.targets.create! amount: 25, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)

sp1.targets.create! amount: 22, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp2.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp3.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp4.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp5.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp6.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp7.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp8.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp9.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp10.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp11.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp12.targets.create! amount: 18, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp13.targets.create! amount: 95, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp14.targets.create! amount: 25, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp15.targets.create! amount: 35, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp16.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp17.targets.create! amount: 50, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp18.targets.create! amount: 50, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp19.targets.create! amount: 50, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp20.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp21.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp22.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp23.targets.create! amount: 25, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp24.targets.create! amount: 125, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp25.targets.create! amount: 50, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
sp26.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
...
nnm1.targets.create! amount: 42, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm2.targets.create! amount: 28, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm3.targets.create! amount: 14, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm4.targets.create! amount: 14, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm5.targets.create! amount: 225, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm6.targets.create! amount: 28, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm7.targets.create! amount: 30, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm8.targets.create! amount: 52, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm9.targets.create! amount: 35, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm10.targets.create! amount: 35, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm11.targets.create! amount: 12, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm12.targets.create! amount: 40, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm13.targets.create! amount: 15, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
nnm14.targets.create! amount: 32, year: 2018, job: Faker::Number.rand(0.0..1.0).round(2)
...
users.each do |s|
  ...
  array.each do |n|
    s.results.create! subject_id: n, mark: float_num(Faker::Number.rand(4.0..10.0)), year: Time.now.year
  end
  array1 = [hoa.id, dia.id]
  array2 = [ly.id, su.id]
  array3 = [sinh.id, nangkhieu.id]
  s.results.create! subject_id: array1.sample, mark: float_num(Faker::Number.rand(4.0..10.0)), year: Time.now.year
  s.results.create! subject_id: array2.sample, mark: float_num(Faker::Number.rand(4.0..10.0)), year: Time.now.year
  s.results.create! subject_id: array3.sample, mark: float_num(Faker::Number.rand(4.0..10.0)), year: Time.now.year
end
...
users.each do |s|
  array = [toan.id, van.id, anh.id]
  array.each do |n|
    s.results.create! subject_id: n, mark: float_num(Faker::Number.rand(4.0..7.0)), year: Time.now.year
  end
  array1 = [hoa.id, dia.id]
  array2 = [ly.id, su.id]
  array3 = [sinh.id, nangkhieu.id]
  s.results.create! subject_id: array1.sample, mark: float_num(Faker::Number.rand(4.0..7.0)), year: Time.now.year
  s.results.create! subject_id: array2.sample, mark: float_num(Faker::Number.rand(4.0..7.0)), year: Time.now.year
  s.results.create! subject_id: array3.sample, mark: float_num(Faker::Number.rand(4.0..7.0)), year: Time.now.year
end
...
users.each do |s|
  array = [toan.id, van.id, anh.id]
  array.each do |n|
    s.results.create! subject_id: n, mark: float_num(Faker::Number.rand(6.0..10.0)), year: Time.now.year
  end
  array1 = [hoa.id, dia.id]
  array2 = [ly.id, su.id]
  array3 = [sinh.id, nangkhieu.id]
  s.results.create! subject_id: array1.sample, mark: float_num(Faker::Number.rand(6.0..10.0)), year: Time.now.year
  s.results.create! subject_id: array2.sample, mark: float_num(Faker::Number.rand(6.0..10.0)), year: Time.now.year
  s.results.create! subject_id: array3.sample, mark: float_num(Faker::Number.rand(6.0..10.0)), year: Time.now.year
end

# bkdn = School.find_by code: "DUT"
# ktdn = School.find_by code: "DUE"
# nndn = School.find_by code: "ULF"
...
#   major_ids = School.first.major_departments.get_by_depart(department_ids).pluck :major_id
...
# toan = Subject.find_by code: "toan"
# ly = Subject.find_by code: "ly"
# hoa = Subject.find_by code: "hoa"
# sinh = Subject.find_by code: "sinh"
# su = Subject.find_by code: "su"
# dia = Subject.find_by code: "dia"
# van = Subject.find_by code: "van"
# anh = Subject.find_by code: "anh"
# nangkhieu = Subject.find_by code: "nangkhieu"

# Result.unscoped.delete_all
# users = User.student.each do |s| #
#   array = [toan.id, van.id, anh.id]
#   array.each do |n|
#     s.results.create! subject_id: n, mark: rand_num.round(1), year: Time.now.year
#   end
#   array1 = [hoa.id, dia.id]
#   array2 = [ly.id, su.id]
#   array3 = [sinh.id, nangkhieu.id]
#   s.results.create! subject_id: array1.sample, mark: rand_num.round(1), year: Time.now.year
#   s.results.create! subject_id: array2.sample, mark: rand_num.round(1), year: Time.now.year
#   s.results.create! subject_id: array3.sample, mark: rand_num.round(1), year: Time.now.year
# end
...
# users = User.student.where.not(id: users_done).limit(4750)
# # users = User.student.where.not(id: users_done).limit(20)
# users.each do |u|
#   department_ids = u.find_user_departments
#   major_ids = bkdn.major_departments.get_by_depart(department_ids).pluck :major_id
#   1.upto(3) do |n|
#     major_id = major_ids.sample
#     next if major_id.blank?
#     major_ids.delete major_id
...
User.student.limit(1000).each do |user|
  school_id = user.registers.first ? user.registers.first.school.id : 1
  file_remarking = user.file_remarkings.build school_id: school_id, year: Time.now.year
  remarkings_ids = {"#{user.results.first.id}" => Faker::Lorem.sentence(50),
    "#{user.results.second.id}" => Faker::Lorem.sentence(50)}
