namespace :data do
  ...
  task generate_data: :environment do
    ...
    [a.id, a1.id, d1.id].each do |id|
      ktm1.major_departments.create! department_id: id
      ktm2.major_departments.create! department_id: id
      ktm3.major_departments.create! department_id: id
      ktm4.major_departments.create! department_id: id
      ktm5.major_departments.create! department_id: id
      ktm6.major_departments.create! department_id: id
      ktm7.major_departments.create! department_id: id
      ktm8.major_departments.create! department_id: id
      ktm9.major_departments.create! department_id: id
      ktm10.major_departments.create! department_id: id
      ktm11.major_departments.create! department_id: id
      ktm12.major_departments.create! department_id: id
      ktm13.major_departments.create! department_id: id
      ktm14.major_departments.create! department_id: id
    end
